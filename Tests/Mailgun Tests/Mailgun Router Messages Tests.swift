...
struct MailgunMessagesRouterTests {
    ...
    func testSendMessageURL() throws {
        ...
        let url = router.url(for: .messages(.send(domain: "test.domain.com", request: sendRequest)))
    ...
    func testSendMimeMessageURL() throws {
        ...
        let url = router.url(for: .messages(.sendMime(domain: "test.domain.com", request: mimeRequest)))
    ...
    func testRetrieveMessageURL() throws {
        ...
        let url = router.url(for: .messages(.retrieve(
    ...
    func testQueueStatusURL() throws {
        ...
        let url = router.url(for: .messages(.queueStatus(domain: "test.domain.com")))
    ...
    func testDeleteScheduledURL() throws {
        ...
        let url = router.url(for: .messages(.deleteScheduled(domain: "test.domain.com")))
